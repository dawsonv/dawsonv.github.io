...
<img src="/assets/dawson.jpg" alt="A picture of me, with a lake in the background" width="350" style="float: right; margin-bottom: 40px; margin-left: 60px; margin-right: 60px;"/>

Hey! My name is Dawson. I'm currently a second-year master's student at UC Berkeley, where I'm affiliated with the [Energy and Resources Group (ERG)](https://erg.berkeley.edu/) and the Energy Modeling, Analysis and Control Group (EMAC). I’m advised by [Professor Duncan Callaway](https://vcresearch.berkeley.edu/faculty/duncan-callaway). 
...
If you want to get in touch, my current email address is verley [at] berkeley.edu. You can also find me on [GitHub](https://github.com/dawsonv), [LinkedIn](https://www.linkedin.com/in/dawson-verley-510618248/) and [Twitter/X](https://x.com/verley_dawson). 
